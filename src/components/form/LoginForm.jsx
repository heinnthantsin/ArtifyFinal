...
export default function CheckoutForm({ handleLogin }) {
    ...
    return (
        <Card className="fixed bottom-1/2 left-1/2 transform -translate-x-1/2 translate-y-1/2 px-5 py-4 bg-[#faf8ff] bg-opacity-10" color="transparent">
            <button className="flex justify-end" onClick={handleLogin}>
                ...
                <Tabs value={type} className="overflow-visible">
                    ...
                    >
                        <TabPanel value="register" className="p-0">
                            <form className="mt-5 mb-2 w-full max-w-md mx-auto">
                                <div className="mb-1 flex flex-col gap-6">
                                    <Typography variant="h6" className="-mb-3 text-gray-100">
                                        Enter Your Email
                                    </Typography>
                                    <Input type="email" label="Your Email" placeholder="JohnDoe@gmail.com" className="text-white" color="white" />

                                    <Typography variant="h6" className="-mb-3 text-gray-100">
                                        Enter Your Password
                                    </Typography>
                                    <Input type="password" label="Password" placeholder="*********" className="text-white" color="white" />
                                </div>
                                <Checkbox
                                    label={
                                        <Typography variant="small" className="flex items-center font-normal text-white">
                                            I agree to the
